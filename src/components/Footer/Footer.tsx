...
export const Footer: FC = () => {
  return (
    <footer className="flex items-center justify-between px-8 pb-8 mt-auto font-extrabold bg-yellow-300 pt-7 text-slate-700">
      <span className="text-2xl">trppd_</span>

      <span className="text-xs">&copy; 2017 - 2018</span>

      <span className="flex justify-center gap-3 sm:ml-auto sm:mt-0 sm:justify-start">
