  ...
  return (
    <footer className="px-5 pt-6 pb-8 font-bold bg-yellow-300 text-slate-700 xl:px-32 md:px-16">
      <div className="flex items-center justify-between mx-auto max-w-screen-2xl">
        <a
          className="text-2xl transition-colors duration-300 ease-in-out cursor-pointer hover:text-zinc-950"
          onClick={onLogoClick}
        >
          trppd_
        </a>
        ...
        <span className="flex justify-center gap-3">
          ...
          >
            <svg
              fill="currentColor"
              className="w-5 h-5 transition-transform duration-300 ease-in-out hover:scale-125"
              viewBox="0 0 24 24"
            >
              <g id="Outlined">
