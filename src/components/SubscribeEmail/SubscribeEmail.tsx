...
const SubscribeEmail: FC = () => {
  ...
  return (
    <section className="flex flex-col items-center justify-center font-bold lg:pt-52 pt-28 md:pt-32 relative before:absolute before:right-0 before:w-10/12 before:h-[2px] before:bg-zinc-500 before:top-0 mb-4 before:rounded-full lg:before:mr-32 before:mr-5 md:before:mr-16 m-auto">
